-- TERMINAL-ORDER-DEFAULTS-001 completes the operational checkout atomically.
drop function public.submit_shop_terminal_order(uuid, uuid, uuid, timestamptz, text, text, jsonb, numeric, uuid, jsonb, text, text);
...
begin
  ...
  if target_production_assignee_id is not null then
...
revoke all on function public.submit_shop_terminal_order(uuid, uuid, uuid, timestamptz, text, text, jsonb, numeric, uuid, jsonb, text, text, uuid, boolean, timestamptz, uuid, text, text, text, text, text, text, text, text)
from public, anon, authenticated;
grant execute on function public.submit_shop_terminal_order(uuid, uuid, uuid, timestamptz, text, text, jsonb, numeric, uuid, jsonb, text, text, uuid, boolean, timestamptz, uuid, text, text, text, text, text, text, text, text)
to authenticated;
