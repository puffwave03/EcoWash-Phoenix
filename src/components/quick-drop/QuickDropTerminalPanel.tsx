...
export type QuickDropText = {
  ...
  confirm: string;
  confirming: string;
  closedDayUnavailable: string;
  detailOrder: string;
  dueAt: string;
  errorGeneric: string;
  errorClosedDay: string;
...
export function QuickDropTerminalPanel({ action, canPrint, canQr, closedDay, customer, locale, locationId, onNewOrder, pending, printText, text }: Props) {
  ...
  function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!customer || closedDay || !locationId || isPending) return;
