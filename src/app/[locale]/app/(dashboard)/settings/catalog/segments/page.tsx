    ...
    <div className="space-y-6">
      ...
      {settings.available ? (
        <CatalogSegmentManagement
          ...
          text={{
            active: t("active"), activeSegments: t("activeSegments"), allCategories: t("allCategories"), assignedCustomers: t("assignedCustomers"), categories: t("categories"), categoryHelp: t("categoryHelp"), categorySearch: t("categorySearch"), clearAll: t("clearAll"), clearAllVisible: t("clearAllVisible"), collapse: t("collapse"), create: t("create"), createDescription: t("createDescription"), createTitle: t("createTitle"), customerHelp: t("customerHelp"), customers: t("customers"), description: t("segmentDescription"), displayOrder: t("displayOrder"), duplicate: t("duplicate"), expand: t("expand"), featured: t("featured"), formError: t("formError"), hidden: t("hidden"), inactive: t("inactive"), inactiveSegments: t("inactiveSegments"), linkedServices: t("linkedServices"), migrationRequired: t("migrationRequired"), name: t("name"), noCustomers: t("noCustomers"), noSegments: t("noSegments"), portalVisibility: t("portalVisibility"), portalVisible: t("portalVisible"), quickNavigation: t("quickNavigation"), save: t("save"), saved: t("saved"), saving: t("saving"), selectAll: t("selectAll"), selectAllVisible: t("selectAllVisible"), serviceHelp: t("serviceHelp"), serviceSearch: t("serviceSearch"), services: t("services"), starter: t("starter"), starterHelp: t("starterHelp"), starters: t.raw("starters") as Record<CatalogSegmentStarter, string>, unavailable: t("unavailable"), visible: t("visible"),
          }}
        />
